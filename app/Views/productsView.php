                        ...
                        <div class="row">
                                ...
                                <div class="ltn__shop-details-img-gallery">
                                    <div class="ltn__shop-details-large-img">
                                        <div class="single-large-img">
                                            <a href="<?php echo base_url() ?>public/assets/img/product/1.png" data-rel="lightcase:myCollection">
                                                <img src="<?php echo base_url() ?>public/assets/img/plate_img/square-plate/4square.png" alt="Image">
                                            </a>
                                        </div>
                                        <div class="single-large-img">
                                            <a href="<?php echo base_url() ?>public/assets/img/plate_img/square-plate/4square.png" data-rel="lightcase:myCollection">
                                                <img src="<?php echo base_url() ?>public/assets/img/plate_img/square-plate/4square.png" alt="Image">
                                            </a>
                                        </div>
                                        <div class="single-large-img">
                            ...
                            <div class="col-md-6">
                                <div class="modal-product-info shop-details-info pl-0">                                    
                                    <h3>10"Square Plates</h3>
                                        
                                    <div class="product-price">
                                        <span>₹49.00</span>
                                        <del>₹65.00</del>
                                        <span class="discount_percentage">Save 10%</span>
                                    </div>
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <span class="quantity-options">
                                                    <input type="radio" id="qty-10" name="quantity" value="10" checked>
                                                    <label for="qty-10">10</label>

                                                    <input type="radio" id="qty-15" name="quantity" value="15">
                                                    <label for="qty-15">15</label>

                                                    <input type="radio" id="qty-20" name="quantity" value="20">
                                                    <label for="qty-20">20</label>

                                                    <input type="radio" id="qty-25" name="quantity" value="25">
                                                    <label for="qty-25">25</label>
                                                </span>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="ltn__product-details-menu-2">
                                        <ul>
                                            ...
                                            <li>
                                                <a href="#" class="theme-btn-1 btn " title="Add to Cart" data-bs-toggle="modal" data-bs-target="#add_to_cart_modal">
                                                    <i class="fas fa-shopping-cart"></i>
                ...
                <div class="col-lg-12">
                    <div class="ltn__product-item ltn__product-item-3 text-center">
                        ...
                        <div class="product-info">
                                                    <h2 class="product-title"><a href="<?php echo base_url('productDetails') ?>">Rounded Plates</a></h2>
                            <div class="product-price">
                                <span>₹149.00</span>
                                <del>₹162.00</del>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                                        <div class="modal-product-img">
                                            <img src="<?php echo base_url() ?>public/assets/img/plate_img/round-plate/10RSP.jpg" alt="#">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="modal-product-img">
                                         ...
                                         <div class="modal-product-info">
                                            ...
                                            <div class="btn-wrapper">
                                                <a href="<?php echo base_url('wishlist')?>" class="theme-btn-1 btn ">View Wishlist</a>
                                            </div>
                                         </div>
                                         <!-- additional-info -->
                                         <div class="additional-info d-none">
