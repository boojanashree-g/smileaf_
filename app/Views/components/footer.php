                ...
                <div class="col-xl-3 col-md-6 col-sm-6 col-12">
                    <div class="footer-widget footer-about-widget">
                        <div class="footer-logo">
                            <div class="site-logo">
                                <img src="<?php echo base_url() ?>public/assets/img/logo-2.png" alt="Logo">
                            </div>
                        </div>
                        <p>We are in the business of Eco Friendly Products in the industry for the past twelve years.
                            We have a basic motive of promoting Eco-friendly environment.</p>
