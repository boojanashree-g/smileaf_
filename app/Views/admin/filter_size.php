...
<body>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <!-- Add Modal -->
                        <div class="modal fade" id="size-modal" tabindex="-1" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    <div class="modal-body">
                                        ...
                                        <div class="text-center mb-6">
                                            <h4 class="size-title mb-2"></h4>
                                        </div>
                                        <form id="menu-form" class="row g-6" onsubmit="return false">
                                            <div class="col-12 col-md-12">
                                                <label class="form-label" for="size_name">Size Name</label>
                                                <input type="text" id="size_name" name="size_name" class="form-control"
                                                    placeholder="Size Name*" />
                                                <span class="error text-danger size_name mt-5"></span>
                                            </div>
    ...
    <script src="<?php echo base_url(); ?>public/admin/custom/js/filter-size.js"></script>
