...
<body>
                ...
                <div class="content-wrapper">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div
                            ...
                            <h4 class="page-title fw-semibold fs-18 mb-0">Manage Delivery Offers</h4>
                            ...
                            <div class="modal-dialog modal-lg modal-simple">
                                <div class="modal-content">
                                    <div class="modal-body">
                                        ...
                                        <form id="" class="row g-6" onsubmit="return false">
                                            <div class="col-12 col-md-12">
                                                <label class="form-label" for="offer_amount">Delivery Offer</label>
                                                <input type="text" id="offer_amount" name="offer_amount"
                                                    class="form-control" placeholder="Delivery Offer Amount*" />
                                                <span class="error text-danger offer_amount mt-5"></span>
                                            </div>
    ...
    <script src="<?php echo base_url(); ?>public/admin/custom/js/courier-charge.js"></script>
