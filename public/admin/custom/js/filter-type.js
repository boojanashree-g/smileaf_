$(document).ready(function () {
  var mode, JSON, res_DATA, type_id;
  ...
  $("#add-detail").click(function () {
    ...
    if (mode == "new") {
      ...
      $(".type-title").text("Add Product Types");
    }
  });
  ...
  $("#btn-submit").click(function () {
    $(".error").hide();
    if ($("#type_name").val() === "" && mode == "new") {
      $(".type_name").html("Please Enter name*").show();
    } else {
      insertData();
    }
  });
  ...
  function insertData() {
    ...
    var url;
    if (mode == "new") {
      url = base_Url + "admin/filter-types/insert-data";
    } else if (mode == "edit") {
      url = base_Url + "admin/filter-types/update-data";
  ...
  function getTypeDetails() {
    ...
    $.ajax({
      type: "POST",
      url: base_Url + "admin/filter-types/get-data",
      dataType: "json",
      success: function (data) {
  ...
  $("#submit-status").click(function () {
    ...
    if (status === "") {
      ...
      $.ajax({
        type: "POST",
        url: base_Url + "admin/filter-types/update-status",
  ...
  $(document).on("click", ".btnEdit", function () {
    ...
    if (mode == "edit") {
      ...
      $(".type-title").text("Edit Product Types");
    }

    var index = $(this).attr("id");
    $("#type_name").val(res_DATA[index].type_name);

    type_id = res_DATA[index].type_id;
  });
  ...
  $(document).on("click", ".BtnDelete", function () {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        $.ajax({
          type: "POST",
          url: base_Url + "admin/filter-types/delete-data",
