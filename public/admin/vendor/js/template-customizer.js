  ...
  return (function () {
    ...
    var t = {
        7621: function (t, e, i) {
          ...
          u.push([
            t.id,
            '#template-customizer{font-family:"Public Sans",BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol" !important;font-size:inherit !important;position:fixed;top:0;right:0;height:100%;z-index:99999999;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;width:400px;-webkit-box-shadow:0px 5px 30px 0px rgba(47,43,61,.18);box-shadow:0px 5px 30px 0px rgba(47,43,61,.18);-webkit-transition:all .2s ease-in;-o-transition:all .2s ease-in;transition:all .2s ease-in;-webkit-transform:translateX(420px);-ms-transform:translateX(420px);transform:translateX(420px)}.dark-style #template-customizer{-webkit-box-shadow:0px 5px 30px 0px rgba(19,17,32,.24);box-shadow:0px 5px 30px 0px rgba(19,17,32,.24)}#template-customizer h5{position:relative;font-size:11px}#template-customizer>h5{flex:0 0 auto}#template-customizer .disabled{color:#d1d2d3 !important}#template-customizer .form-label{font-size:.9375rem}#template-customizer .form-check-label{font-size:.8125rem}#template-customizer.template-customizer-open{-webkit-transition-delay:.1s;-o-transition-delay:.1s;transition-delay:.1s;-webkit-transform:none !important;-ms-transform:none !important;transform:none !important}#template-customizer.template-customizer-open .custom-option.checked{color:var(--bs-primary);border-width:2px;margin:0}#template-customizer .template-customizer-header a:hover{color:inherit !important}#template-customizer .template-customizer-open-btn{position:absolute;top:180px;left:0;z-index:-1;display:block;width:38px;height:38px;border-top-left-radius:.375rem;border-bottom-left-radius:.375rem;background:var(--bs-primary);box-shadow:0px 2px 6px 0px rgba(115,103,240,.3);color:#fff !important;text-align:center;font-size:18px !important;line-height:38px;opacity:1;-webkit-transition:all .1s linear .2s;-o-transition:all .1s linear .2s;transition:all .1s linear .2s;-webkit-transform:translateX(-58px);-ms-transform:translateX(-58px);transform:translateX(-58px)}@media(max-width: 991.98px){#template-customizer .template-customizer-open-btn{top:145px}}.dark-style #template-customizer .template-customizer-open-btn{background:var(--bs-primary)}#template-customizer .template-customizer-open-btn::before{content:"";width:22px;height:22px;display:block;background-size:100% 100%;position:absolute;background-image:url(' +
              d +
          ...
          function s(t, s) {
            for (var n = {}, o = [], r = 0; r < t.length; r++) {
              ...
              if (-1 !== m) e[m].references++, e[m].updater(h);
                ...
                var p = a(h, s);
                (s.byIndex = r),
                  e.splice(r, 0, { identifier: d, updater: p, references: 1 });
              }
              o.push(d);
            }
            return o;
    ...
    return (
      (function () {
        ...
        b = w.contains("layout-navbar-fixed")
          ? "sticky"
          : w.contains("layout-navbar-hidden")
          ? "hidden"
          : "static";
        var z =
            document
          ...
          O = w.contains("layout-menu-offcanvas")
            ? "static-offcanvas"
            : w.contains("layout-menu-fixed")
            ? "fixed"
                ...
                if (
                  ...
                  -1 !== P &&
                    (this.settings.controls = this.settings.controls
                      .slice(0, P)
                      .concat(this.settings.controls.slice(P + 1)));
                }
                  ...
                  value: function (e) {
                    ...
                    if (e !== this.settings.lang || a) {
                      ...
                      for (
                        ...
                        ).textContent = o[u] || this._getThemeByName(u).title;
                      }
                  ...
                  value: function () {
                    ...
                    "" !== u
                      ...
                      (this.settings.contentLayout =
                        "" !== n ? n : this.settings.defaultContentLayout),
                      ...
                      (e =
                        "" !== l &&
                        -1 !== ["static", "sticky", "hidden"].indexOf(l)
                          ? l
                      ...
                      this._hasControls("style") ||
                        (this.settings.style = w.contains("dark-style")
                          ? "dark"
                          : "light"),
                      this._hasControls("contentLayout") ||
                  ...
                  value: function () {
                        ...
                        return (
                          ...
                          t._getElementFromString(
                            '<div class="col-4 px-2">\n      <div class="form-check custom-option custom-option-icon">\n        <label class="form-check-label custom-option-content p-0" for="'
                              ...
                              .concat(
                                e,
                                '" />\n        </label>\n      </div>\n      <label class="form-check-label small text-nowrap text-body mt-1" for="'
                              )
                              .concat(s)
                              .concat(e, '">')
                              .concat(i, "</label>\n    </div>")
                    ...
                    if (this._hasControls("themes")) {
                      this.settings.availableThemes.forEach(function (t) {
                        var e;
                        e =
                          "theme-semi-dark" === t.name
                            ? "semi-dark"
                            : "theme-bordered" === t.name
                            ? "border"
                            : "default";
                        var s = i(
                          t.name,
                      ...
                      if (this._hasControls("rtl") && rtlSupport) {
                        ...
                        var _ = function (e) {
                          t._loadingState(!0),
                            ...
                            "ar" === t._getSetting("Lang")
                              ? t._setSetting("Lang", "en")
                              : t._setSetting("Lang", "ar"),
                    ...
                    setTimeout(function () {
                      ...
                      document.querySelector(".menu-vertical")
                        ...
                        : document.querySelector(".menu-horizontal") &&
                          (t._hasControls("rtl contentLayout headerType", !0) ||
                            (e && e.parentNode.removeChild(e)));
                    }, 100),
                  ...
                  value: function (t) {
                    ...
                    try {
                      e = localStorage.getItem(
                        "templateCustomizer-".concat(i, "--").concat(t)
                      );
                    } catch (t) {}
                    return String(e || "");
                  },
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    return t.split(" ").reduce(function (t, s) {
                      return (
                        -1 !== e.settings.controls.indexOf(s)
                          ? (i || !1 !== t) && (t = !0)
                          : (i && !0 === t) || (t = !1),
                        t
                      );
                  ...
                  value: function (t) {
                    for (
                      var e =
                          ...
                          void 0 !== arguments[1] &&
                          arguments[1],
                        i = this.settings.availableThemes,
                        s = 0,
                        a = i.length;
                      s < a;
                      s++
