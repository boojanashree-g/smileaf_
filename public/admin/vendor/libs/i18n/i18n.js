            ...
            !(function (e) {
              ...
              if (a)
                var l = [
                  ...
                  u =
                    ...
                    function (t) {
                      return (
                        t && l.indexOf(Object.prototype.toString.call(t)) > -1
                      );
                    };
              function c(t) {
                if (
              ...
              (f.prototype.append = function (t, e) {
                ...
                (f.prototype.forEach = function (t, e) {
                  for (var o in this.map)
                    this.map.hasOwnProperty(o) &&
                      t.call(e, this.map[o], o, this);
                }),
              ...
              function w(t, e) {
                ...
                if (
                  ...
                  (this.method =
                    ((n = (o = e.method || this.method || "GET").toUpperCase()),
                    v.indexOf(n) > -1 ? n : o)),
      ...
      (function () {
        ...
        class n {
          ...
          off(t, e) {
            this.observers[t] &&
              (e
                ? (this.observers[t] = this.observers[t].filter((t) => t !== e))
        ...
        function y(t, e) {
          ...
          for (let t = 0; t < n.length; ++t) {
            if (!r) return;
            if ("string" == typeof r[n[t]] && t + 1 < n.length) return;
            if (void 0 === r[n[t]]) {
              let i = 2,
                s = n.slice(t, t + i).join(o),
                a = r[s];
              for (; void 0 === a && n.length > t + i; )
                i++, (s = n.slice(t, t + i).join(o)), (a = r[s]);
              if (void 0 === a) return;
        ...
        class b extends n {
          ...
          getResource(t, e, o) {
            ...
            return a || !i || "string" != typeof o
              ? a
              : y(this.data && this.data[t] && this.data[t][e], o, r);
          }
          addResource(t, e, o, n) {
            let r =
            ...
            o && (s = s.concat(i ? o.split(i) : o)),
              t.indexOf(".") > -1 && ((s = t.split(".")), (n = e), (e = s[1])),
          ...
          addResources(t, e, o) {
            ...
            for (const n in o)
              ("string" != typeof o[n] &&
                "[object Array]" !== Object.prototype.toString.apply(o[n])) ||
                this.addResource(t, e, n, o[n], { silent: !0 });
          ...
          hasLanguageSomeTranslations(t) {
            ...
            return !!((e && Object.keys(e)) || []).find(
              (t) => e[t] && Object.keys(e[t]).length > 0
            );
          }
          toJSON() {
            return this.data;
        ...
        var v = {
          ...
          handle(t, e, o, n, r) {
            return (
              t.forEach((t) => {
                this.processors[t] &&
                  (e = this.processors[t].process(e, o, n, r));
              }),
              e
            );
          },
        ...
        class x extends n {
          ...
          extractFromKey(t, e) {
            ...
            if (i && !s) {
              ...
              if (e && e.length > 0) return { key: t, namespaces: r };
              const i = t.split(o);
              (o !== n || (o === n && this.options.ns.indexOf(i[0]) > -1)) &&
                (r = i.shift()),
                (t = i.join(n));
            }
          ...
          translate(t, e, o) {
            ...
            const n =
              ...
              r =
                void 0 !== e.keySeparator
                  ? e.keySeparator
                  : this.options.keySeparator,
              { key: i, namespaces: s } = this.extractFromKey(
                t[t.length - 1],
                e
              ),
              a = s[s.length - 1],
            ...
            if (
              ...
              ("string" != typeof g || "[object Array]" !== d)
            ) {
              if (!e.returnObjects && !this.options.returnObjects) {
                ...
                const t = this.options.returnedObjectHandler
                  ? this.options.returnedObjectHandler(h, p, { ...e, ns: s })
              ...
              if (r) {
                ...
                for (const t in p)
                  if (Object.prototype.hasOwnProperty.call(p, t)) {
                    const i = `${n}${r}${t}`;
                    (o[t] = this.translate(i, { ...e, joinArrays: !1, ns: s })),
                      o[t] === i && (o[t] = p[t]);
                  }
                p = o;
              }
            } else if (y && "string" == typeof g && "[object Array]" === d)
              (p = p.join(g)), p && (p = this.extendTranslation(p, t, e, o));
            else {
              let n = !1,
                s = !1;
              const u = void 0 !== e.count && "string" != typeof e.count,
                ...
                d =
                  e.ordinal && u
                    ? this.pluralResolver.getSuffix(l, e.count, { ordinal: !1 })
                    : "",
                g =
                  u &&
                  !e.ordinal &&
                ...
                y =
                  (g && e[`defaultValue${this.options.pluralSeparator}zero`]) ||
                  e[`defaultValue${f}`] ||
                  e[`defaultValue${d}`] ||
                  e.defaultValue;
              !this.isValidLookup(p) && h && ((n = !0), (p = y)),
              ...
              if (s || n || b) {
                if (
                  ...
                  const t = this.resolve(i, { ...e, keySeparator: !1 });
                  t &&
                    t.res &&
                    this.logger.warn(
                ...
                const n = (t, o, n) => {
                  ...
                  this.options.missingKeyHandler
                    ? this.options.missingKeyHandler(t, a, o, r, b, e)
                    : this.backendConnector &&
                      this.backendConnector.saveMissing &&
                      this.backendConnector.saveMissing(t, a, o, r, b, e),
                  ...
                  (this.options.saveMissingPlurals && u
                    ? t.forEach((t) => {
                        ...
                        g &&
                          ...
                          o.indexOf(`${this.options.pluralSeparator}zero`) <
                            0 &&
            ...
            return n
              ? ((c.res = p), (c.usedParams = this.getUsedParamsDetails(e)), c)
              : p;
          }
                  ...
                  (t = this.interpolator.nest(
                    ...
                    function () {
                      ...
                      return r && r[0] === n[0] && !o.context
                        ? (i.logger.warn(
                            `It seems you are nesting recursively key: ${n[0]} in key: ${e[0]}`
                          ),
                          null)
                        : i.translate(...n, e);
                    },
                ...
                u.forEach((t) => {
                  this.isValidLookup(e) ||
                    ...
                    f.forEach((o) => {
                        ...
                        if (
                          (c &&
                            ...
                            s.ordinal &&
                              0 === t.indexOf(n) &&
                              i.push(
                                l + t.replace(n, this.options.pluralSeparator)
                              ),
                            p && i.push(l + e)),
                          h)
                        ) {
                          ...
                          i.push(o),
                            c &&
                              ...
                              s.ordinal &&
                                0 === t.indexOf(n) &&
                                i.push(
                                  o + t.replace(n, this.options.pluralSeparator)
                                ),
                              p && i.push(o + e));
                        }
                      }
                      ...
                      for (; (a = i.pop()); )
                        this.isValidLookup(e) ||
                          ((n = a), (e = this.getResource(o, t, a, s)));
                    }));
                });
              }),
              { res: e, usedKey: o, exactUsedKey: n, usedLng: r, usedNS: i }
            );
          }
          isValidLookup(t) {
            return !(
          ...
          getResource(t, e, o) {
            ...
            return this.i18nFormat && this.i18nFormat.getResource
              ? this.i18nFormat.getResource(t, e, o, n)
              : this.resourceStore.getResource(t, e, o, n);
          }
          getUsedParamsDetails() {
            ...
            let n = o ? t.replace : t;
            if (
              (o && void 0 !== t.count && (n.count = t.count),
              this.options.interpolation.defaultVariables &&
        ...
        class O {
            ...
            if ("string" == typeof t && t.indexOf("-") > -1) {
              ...
              return (
                this.options.lowerCaseLng
                  ? (o = o.map((t) => t.toLowerCase()))
                  : 2 === o.length
                  ? ((o[0] = o[0].toLowerCase()),
                    (o[1] = o[1].toUpperCase()),
                    e.indexOf(o[1].toLowerCase()) > -1 &&
                      (o[1] = S(o[1].toLowerCase())))
                  : 3 === o.length &&
                    ((o[0] = o[0].toLowerCase()),
                    ...
                    e.indexOf(o[1].toLowerCase()) > -1 &&
                      (o[1] = S(o[1].toLowerCase())),
                    e.indexOf(o[2].toLowerCase()) > -1 &&
                      (o[2] = S(o[2].toLowerCase()))),
                o.join("-")
              );
            }
          ...
          getFallbackCodes(t, e) {
            ...
            let o = t[e];
            return (
              o || (o = t[this.getScriptPartFromCode(e)]),
              ...
              r = (t) => {
                t &&
                  (this.isSupportedCode(t)
                    ? n.push(t)
                    : this.logger.warn(
                        `rejecting language code not found in supportedLngs: ${t}`
                      ));
              };
            return (
              "string" == typeof t &&
        ...
        const P = ["v1", "v2", "v3"],
          j = ["v4"],
          R = { zero: 0, one: 1, two: 2, few: 3, many: 4, other: 5 };
        class E {
          constructor(t) {
            let e =
              arguments.length > 1 && void 0 !== arguments[1]
            ...
            (this.languageUtils = t),
              ...
              (this.options.compatibilityJSON &&
                !j.includes(this.options.compatibilityJSON)) ||
              ...
              (this.rules = (function () {
                ...
                return (
                  k.forEach((e) => {
                    e.lngs.forEach((o) => {
                      t[o] = { numbers: e.nr, plurals: L[e.fc] };
                    });
                  }),
                  t
                );
          ...
          getSuffixes(t) {
            ...
            return o
              ? this.shouldUseIntlApi()
                ? o
                    .resolvedOptions()
                    .pluralCategories.sort((t, e) => R[t] - R[e])
                    .map(
                      (t) =>
                        `${this.options.prepend}${
                          e.ordinal ? `ordinal${this.options.prepend}` : ""
                        }${t}`
                    )
                : o.numbers.map((o) => this.getSuffix(t, o, e))
              : [];
          }
          getSuffix(t, e) {
            let o =
            ...
            return n
              ? this.shouldUseIntlApi()
                ...
                : this.getSuffixRetroCompatible(n, e)
        ...
        class N {
          constructor() {
            ...
            (this.logger = o.create("interpolator")),
              (this.options = t),
              (this.format =
                (t.interpolation && t.interpolation.format) || ((t) => t)),
              this.init(t);
          }
          init() {
            let t =
            ...
            (this.escape = void 0 !== e.escape ? e.escape : d),
              ...
              (this.nestingPrefix = e.nestingPrefix
                ? h(e.nestingPrefix)
                : e.nestingPrefixEscaped || h("$t(")),
              (this.nestingSuffix = e.nestingSuffix
                ? h(e.nestingSuffix)
                : e.nestingSuffixEscaped || h(")")),
          ...
          interpolate(t, e, o, n) {
            ...
            return (
              [
                { regex: this.regexpUnescape, safeValue: (t) => u(t) },
                {
                  regex: this.regexp,
                  safeValue: (t) =>
                    this.escapeValue ? u(this.escape(t)) : u(t),
                },
              ].forEach((e) => {
          ...
          nest(t, e) {
            ...
            function s(t, e) {
              ...
              let i = `{${n[1]}`;
              (t = n[0]), (i = this.interpolate(i, r));
              const s = i.match(/'/g),
                a = i.match(/"/g);
              ((s && s.length % 2 == 0 && !a) || a.length % 2 != 0) &&
                (i = i.replace(/'/g, '"'));
              try {
                (r = JSON.parse(i)), e && (r = { ...e, ...r });
              } catch (e) {
                return (
                  this.logger.warn(
                    `failed parsing options string in nesting for key ${t}`,
                    e
                  ),
                  `${t}${o}${i}`
                );
              }
              return delete r.defaultValue, t;
            }
          ...
          constructor() {
            ...
            (this.logger = o.create("formatter")),
              ...
              (this.formats = {
                ...
                datetime: T((t, e) => {
                  const o = new Intl.DateTimeFormat(t, { ...e });
                  return (t) => o.format(t);
                }),
                relativetime: T((t, e) => {
                  const o = new Intl.RelativeTimeFormat(t, { ...e });
                  return (t) => o.format(t, e.range || "day");
                }),
                list: T((t, e) => {
                  const o = new Intl.ListFormat(t, { ...e });
                  return (t) => o.format(t);
                }),
              }),
              this.init(t);
            ...
            return e.split(this.formatSeparator).reduce((t, e) => {
              const { formatName: r, formatOptions: i } = (function (t) {
                ...
                if (t.indexOf("(") > -1) {
                  ...
                  "currency" === e && r.indexOf(":") < 0
                    ? o.currency || (o.currency = r.trim())
                    : "relativetime" === e && r.indexOf(":") < 0
                    ? o.range || (o.range = r.trim())
                    : r.split(";").forEach((t) => {
                        if (!t) return;
                        const [e, ...n] = t.split(":"),
                          r = n
                ...
                return { formatName: e, formatOptions: o };
              })(e);
              if (this.formats[r]) {
                let e = t;
                try {
              ...
              return (
                this.logger.warn(`there was no format function for ${r}`), t
              );
            }, t);
          }
        }
        class D extends n {
          ...
          queueLoad(t, e, o, n) {
            ...
            return (
              t.forEach((t) => {
                ...
                e.forEach((e) => {
                  const s = `${t}|${e}`;
                  !o.reload && this.store.hasResourceBundle(t, e)
                    ? (this.state[s] = 2)
                    : this.state[s] < 0 ||
                      (1 === this.state[s]
                        ? void 0 === i[s] && (i[s] = !0)
          ...
          loaded(t, e, o) {
            ...
            this.queue.forEach((o) => {
              !(function (t, e, o, n) {
                ...
                0 !== o.pendingCount ||
                  o.done ||
                  (Object.keys(o.loaded).forEach((t) => {
                    s[t] || (s[t] = {});
                    const e = o.loaded[t];
                    e.length &&
                      e.forEach((e) => {
          ...
          reload(t, e, o) {
            this.prepareLoading(t, e, { reload: !0 }, o);
          }
          loadOne(t) {
            let e =
              arguments.length > 1 && void 0 !== arguments[1]
            ...
            this.read(n, r, "read", void 0, void 0, (o, i) => {
              o &&
                this.logger.warn(
                  `${e}loading namespace ${r} for language ${n} failed`,
                  o
                ),
                !o &&
                  i &&
                  this.logger.log(
                    `${e}loaded namespace ${r} for language ${n}`,
                    i
                  ),
                this.loaded(t, o, i);
            });
          ...
          saveMissing(t, e, o, n, r) {
            ...
            if (
              ...
              this.logger.warn(
                `did not save key "${o}" as the namespace "${e}" was not yet loaded`,
                "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!"
              );
            else if (null != o && "" !== o) {
              if (this.backend && this.backend.create) {
                const a = { ...i, isUpdate: r },
        ...
        class F extends n {
          ...
          init() {
            ...
            if (
              ((this.options = { ...r, ...this.options, ...I(e) }),
              "v1" !== this.options.compatibilityAPI &&
                (this.options.interpolation = {
                  ...r.interpolation,
                  ...this.options.interpolation,
            ...
            if (
              ...
              const t = this.services.languageUtils.getFallbackCodes(
                this.options.fallbackLng
              );
            ...
            if (
              ...
              o
                ...
                this.options.preload &&
                  this.options.preload.forEach((t) => n(t)),
          ...
          dir(t) {
            if (
              ...
              return "rtl";
            const e =
              (this.services && this.services.languageUtils) || new O($());
            return [
              "ar",
              "shu",
              "sqr",
              ...
              "sam",
              "ckb",
            ].indexOf(e.getLanguagePartFromCode(t)) > -1 ||
          ...
          cloneInstance() {
            ...
            const n = { ...this.options, ...t, isClone: !0 },
              r = new F(n);
            return (
              ...
              o &&
                ((r.store = new b(this.store.data, n)),
        ...
        var W = function (t, e) {
          ...
          Y = function (t, e, o) {
            var n = function (t) {
              if (!t.ok)
                return o(t.statusText || "Error", { status: t.status });
              t.text()
                .then(function (e) {
                  o(null, { status: t.status, data: e });
                })
                .catch(o);
            };
            "function" == typeof fetch
              ? fetch(t, e).then(n).catch(o)
              : H(t, e).then(n).catch(o);
          },
          Q = !1,
          Z = function (t, e, o, n) {
            return (
              ...
              H && 0 !== e.indexOf("file:")
                ? (function (t, e, o, n) {
                    ...
                    try {
                      ...
                      if (
                        ...
                        !t.message ||
                        t.message.indexOf("not implemented") < 0
                      )
                        return n(t);
                      try {
                ...
                : M() || "function" == typeof ActiveXObject
                ? (function (t, e, o, n) {
                    o && "object" === G(o) && (o = W("", o).slice(1)),
                      t.queryStringParams && (e = W(e, t.queryStringParams));
                    try {
                      var r;
                      (r = V ? new V() : new q("MSXML2.XMLHTTP.3.0")).open(
                        o ? "POST" : "GET",
                        e,
                        1
                      ),
                      ...
                      if ((i = "function" == typeof i ? i() : i))
                        for (var s in i) r.setRequestHeader(s, i[s]);
                      (r.onreadystatechange = function () {
                        r.readyState > 3 &&
                          n(r.status >= 400 ? r.statusText : null, {
                            status: r.status,
                            data: r.responseText,
                          });
                      }),
                ...
                value: function (t, e, o, n) {
                  ...
                  this.options.request(this.options, t, a, function (i, s) {
                    if (s && ((s.status >= 500 && s.status < 600) || !s.status))
                      return e(
                        "failed loading " + t + "; status code: " + s.status,
                        !0
                      );
          ...
          yt = {
            ...
            lookup: function (t) {
              ...
              if ("undefined" != typeof window) {
                ...
                for (
                  var n = o.substring(1).split("&"), r = 0;
                  r < n.length;
                  r++
                ) {
                  var i = n[r].indexOf("=");
                  i > 0 &&
                    n[r].substring(0, i) === t.lookupQuerystring &&
                    (e = n[r].substring(i + 1));
                }
              }
              return e;
                  ...
                  value: function (t) {
                    ...
                    (this.services = t || { languageUtils: {} }),
                      (this.options = (function (t) {
                        return (
                          ht.call(ft.call(arguments, 1), function (e) {
                            if (e)
                      ...
                      e &&
                        ((this.options.excludeCacheFor &&
                          ...
                          e.forEach(function (e) {
                            o.detectors[e] &&
                              o.detectors[e].cacheUserLanguage(t, o.options);
                          }));
                  },
                },
              ]),
