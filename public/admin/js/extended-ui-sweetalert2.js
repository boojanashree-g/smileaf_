...
!(function () {
  var t = document.querySelector("#basic-alert"),
    ...
    a = document.querySelector("#position-bottom-start"),
    c = document.querySelector("#position-bottom-end"),
    ...
    g = document.querySelector("#type-error"),
    d = document.querySelector("#type-question"),
    S = document.querySelector("#custom-image"),
    y = document.querySelector("#auto-close"),
    v = document.querySelector("#outside-click"),
    p = document.querySelector("#progress-steps"),
    C = document.querySelector("#ajax-request"),
